<?php
$this->assign('title', __d('panel', 'Upload Post cover(s)'));

$this->start('breadcrumbs');
$breadcrumbs = [
    ['title' => __d('panel', 'Files'), 'url' => ['action' => 'index']],
    ['title' => __d('panel', 'Upload Post cover(s)')]
];
...
<div class="subheader">
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-plus-circle"></i> <?= __d('panel', 'Upload Post cover(s)') ?>
    </h1>
    <div class="subheader-block d-none d-sm-flex align-items-center">
        ...
        <?= $this->Html->link(__d('panel', 'Upload file(s)'), ['action' => 'add'], ['class' => 'btn btn-xs btn-success ml-2']) ?>
    </div>
</div>

<div class="alert alert-warning" role="alert">
    <strong><?= __d('panel', 'Image Requirement!') ?></strong> <?= __d('panel', 'Width:  960px') ?>, <?= __d('panel', 'Height: 600px') ?>
</div>

<?= $this->Form->create($file, ['type' => 'file', 'class' => 'dropzone needsclick', 'id' => 'form']) ?>
<div class="dz-message needsclick">
    <i class="fal fa-cloud-upload text-muted mb-3"></i> <br>
    <span class="text-uppercase"><?= __d('panel', 'Drop images here or click to upload') ?></span>
</div>
<?= $this->Form->end() ?>
