<?php
$this->assign('title', __d('panel', 'Post cover'));

$this->start('breadcrumbs');
$breadcrumbs = [
    ['title' => __d('panel', 'Files')],
    ['title' => __d('panel', 'Post cover')]
];
echo $this->element('breadcrumbs', ['breadcrumbs' => $breadcrumbs]);
$this->end();

$this->start('navigation');
$menu['files']['types']['post_cover'] = true;
...
<div class="subheader">
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-image"></i> <?= __d('panel', 'Post cover') ?>
    </h1>
</div>
    ...
    <div class="col-12">
        <div class="grid">
            ...
            foreach($files as $file) {
                echo $this->Html->link(
                    $this->Image->display($file, '200x125', ['class' => 'img-fluid']),
                    '#',
                    [
                        'escape' => false,
                        'class' => 'detail-image',
