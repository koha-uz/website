...
<div class="subheader">
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-edit"></i> <?= __d('panel', 'Edit') ?>
    </h1>
</div>
                ...
                <div class="panel-content">
                    ...
                    <div class="d-flex border-top mt-3 pt-3">
                        ...
                        echo $this->Form->postLink(
                            ...
                            $this->Url->build(['action' => 'delete', h($faq->id)]),
                            [
                                'class' => 'color-danger-900 mt-2 pr-2 mr-auto',
                                'data-title' => __d('panel', 'Are you sure you want to delete the faq?'),
