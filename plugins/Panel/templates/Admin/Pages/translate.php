<?php
$this->assign('title', __d('admin', 'Page Translation: {0}', h($page->title)));
...
<div class="subheader">
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-globe"></i> <?= __d('admin', 'Page Translation:') ?> 
        <?= $this->AuthUser->link(h($page->title), ['action' => 'edit', h($page->id)]) ?>
    </h1>
</div>
