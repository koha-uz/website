...
<html lang="<?= $this->request->getParam('lang') ?>">
    ...
    <script>
        ...
        <?= $this->Html->script('https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.27.0/moment.min.js') ?>
        <?= $this->Html->script('https://momentjs.com/downloads/moment-timezone-with-data.js') ?>
