<?php
$this->assign('title', __d('panel', 'Create ad'));
...
<div class="subheader">
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-plus-circle"></i> <?= __d('panel', 'Create ad') ?>
    </h1>
</div>
                ...
                <div class="panel-content">
                    ...
                    <div class="tab-content p-3 border border-top-0">
                        ...
                        <div class="tab-pane fade" id="tab_ru" role="tabpanel">
                            ...
                            echo $this->Form->control('_translations.ru.notes', [
                                'label' => ['class' => 'sr-only'],
                                'placeholder' => __d('panel', 'Notes'),
                                'rows' => 2
                            ]);
        ...
        <div id="panel-4" class="panel shadow-0" data-panel-close data-panel-sortable data-panel-fullscreen data-panel-refresh data-panel-locked>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    if (!empty($ad->cover)) {
                        echo $this->Image->display($ad->cover, null, ['class' => 'img-fluid mt-2']);
