<?php
$this->assign('title', __d('panel', 'Create document'));

$this->start('breadcrumbs');
$breadcrumbs = [
    ['title' => __d('panel', 'Dcouments'), 'url' => ['controller' => 'Docs', 'action' => 'index']],
...
<div class="subheader">
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-plus-circle"></i> <?= __d('panel', 'Create document') ?>
    </h1>
</div>
